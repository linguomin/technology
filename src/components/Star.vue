        ...
        <div class="col-xs-12" style="padding: 0;">
          <nav id="nav">
            <div class="nav container">
              <div class="row">
                <a href="#">
                  <div class="nav_title1 col-lg-3 hidden-md hidden-sm hidden-xs">
                    移动设备
                    <span></span>
                  </div>
                </a>
                <a href="#">
                  <div class="nav_title2 col-lg-3 hidden-md hidden-sm hidden-xs">
                    人工智能
                    <span></span>
                  </div>
                </a>
                <a href="#">
                  <div class="nav_title3 col-lg-3 hidden-md hidden-sm hidden-xs">
                    VR
                    <span></span>
                  </div>
                </a>
                <a href="#">
                  <div class="nav_title4 col-lg-3 hidden-md hidden-sm hidden-xs">
                    无人机
                    <span></span>
                  </div>
                </a>
...
<style scoped lang="less">
  .myStar{
    ...
    #nav .nav div[class^=nav_title] {
      width:168px;
      height: 168px;
      border-radius: 50%;
      border: 2px solid #c9e2b3;
      font-size:2rem;
      line-height: 168px;
      transition:all 1s;
      position:relative;
    ...
    #nav .nav div[class^=nav_title] span{
    ...
    #nav .nav div.nav_title1 span{
      background:url(../assets/img/tit/t1.jpg) no-repeat;
    }
    #nav .nav div[class^=nav_title] span:hover{
      opacity:1;
      transition:all 0.8s;
    }
    #nav .nav div.nav_title2 span{
      background:url(../assets/img/tit/t2.jpg) no-repeat;
    }
    #nav .nav div.nav_title3 span{
      background:url(../assets/img/tit/t3.jpg) no-repeat;
    }
    #nav .nav div.nav_title4 span{
      background:url(../assets/img/tit/t4.jpg) no-repeat;
    }
    #stars{
      position:absolute;
      top:0;
    ...
    .stars {
      ...
      -o-animation:fly 2s linear infinite;
